...
INPUT_HISTORICAL_CSV <- "example/hist"  # optional
...
#ACROSS THE HISTORY IN THE ATP WEB I REALLY RECOMMEND YOU TO READ CAREFULLY THE CODES AND CHANGE THE PRE-SEEDING FOR YOUR OWN SCRAPPED DATA.
